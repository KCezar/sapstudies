		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#routetestrouteapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"routetestrouteapp-display": {
								"semanticObject": "routetestrouteapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=route.test.routeapp",
									"url": sap.ui.require.toUrl("route/test/routeapp")
								}
							}
						}
					}
