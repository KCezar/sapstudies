		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "No app manage route",
									"targetURL": "#noappmanageroutenoappmanageroute-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"noappmanageroutenoappmanageroute-display": {
								"semanticObject": "noappmanageroutenoappmanageroute",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=no.app.manage.route.noappmanageroute",
									"url": sap.ui.require.toUrl("no/app/manage/route/noappmanageroute")
								}
							}
						}
					}
