sap.ui.define([
	...
	var FragmentControlRenderer = Renderer.extend("route.test.routeapp.controls.FragmentControlRenderer", {
		...
		render: function(oRenderManager, oControl) {
			...
			// render fragment controls (@see route.test.routeapp.controls.fragment.FragmentControl.metadata.properties._aFragmentControls)
