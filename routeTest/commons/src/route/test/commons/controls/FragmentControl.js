sap.ui.define([
	...
	"route/test/routeapp/controls/FragmentControlRenderer"
	 ...
	 */
	var FragmentControl = Control.extend("route.test.routeapp.controls.FragmentControl", {
