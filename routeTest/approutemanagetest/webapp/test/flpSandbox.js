		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Route Manage Test",
									"targetURL": "#approutemanageapproutemanagetest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"approutemanageapproutemanagetest-display": {
								"semanticObject": "approutemanageapproutemanagetest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.route.manage.approutemanagetest",
									"url": sap.ui.require.toUrl("app/route/manage/approutemanagetest")
								}
							}
						}
					}
